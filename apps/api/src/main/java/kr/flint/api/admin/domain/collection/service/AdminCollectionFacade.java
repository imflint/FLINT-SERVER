package kr.flint.api.admin.domain.collection.service;
...
import kr.flint.api.admin.domain.collection.dto.request.AdminCollectionUpdateReq;
import kr.flint.api.admin.domain.collection.dto.request.AdminCollectionVisibility;
import kr.flint.api.admin.domain.collection.dto.response.AdminCollectionDetailRes;
import kr.flint.api.admin.domain.collection.dto.response.AdminCollectionSummaryRes;
import kr.flint.api.admin.domain.collection.repository.AdminCollectionQueryRepository;
import kr.flint.api.admin.domain.collection.repository.AdminCollectionQueryRepository.CollectionContentRow;
import kr.flint.api.admin.domain.collection.repository.AdminCollectionQueryRepository.CollectionDetailRow;
import kr.flint.api.admin.domain.collection.repository.AdminCollectionQueryRepository.CollectionSummaryRow;
