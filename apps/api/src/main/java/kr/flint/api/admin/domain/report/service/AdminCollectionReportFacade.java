package kr.flint.api.admin.domain.report.service;
...
import kr.flint.api.admin.common.AdminAuthorizationService;
import kr.flint.api.admin.domain.report.dto.request.AdminCollectionReportResolutionReq;
import kr.flint.api.admin.domain.report.dto.response.AdminCollectionReportDetailRes;
import kr.flint.api.admin.domain.report.dto.response.AdminCollectionReportSummaryRes;
import kr.flint.api.admin.domain.report.repository.AdminCollectionReportQueryRepository;
import kr.flint.api.admin.domain.report.repository.AdminCollectionReportQueryRepository.ReportContentRow;
import kr.flint.api.admin.domain.report.repository.AdminCollectionReportQueryRepository.ReportDetailRow;
import kr.flint.api.admin.domain.report.repository.AdminCollectionReportQueryRepository.ReportSummaryRow;
import kr.flint.api.admin.domain.user.service.AdminUserModerationApplicationService;
