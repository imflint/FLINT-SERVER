package kr.flint.api.admin.domain.terms.controller;
...
import kr.flint.api.admin.domain.terms.controller.spec.TermsAdminControllerDocs;
import kr.flint.api.admin.domain.terms.dto.request.TermsCreateReq;
import kr.flint.api.admin.domain.terms.dto.request.TermsListSort;
import kr.flint.api.admin.domain.terms.service.AdminTermsCommandFacade;
import kr.flint.api.admin.domain.terms.service.AdminTermsQueryFacade;
...
public class TermsAdminController implements TermsAdminControllerDocs {
    ...
    private final AdminTermsCommandFacade termsCommandFacade;
    private final AdminTermsQueryFacade termsQueryFacade;
