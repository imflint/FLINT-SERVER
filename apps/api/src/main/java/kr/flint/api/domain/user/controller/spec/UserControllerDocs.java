...
public interface UserControllerDocs {
    ...
    @Operation(summary = "닉네임 중복 체크", description = "닉네임 사용 가능 여부를 확인합니다. - 호주")
    @ApiResponses({
    ...
    @Operation(summary = "내 프로필 조회", description = "로그인한 사용자 본인의 프로필 정보를 조회합니다. - 호주")
    @ApiResponses({
    ...
    @Operation(summary = "내 취향 키워드 조회", description = "로그인한 사용자 본인의 취향 키워드 목록을 조회합니다. - 호주")
    @ApiResponses({
    ...
    @Operation(summary = "내 컬렉션 조회", description = "로그인한 사용자 본인이 생성한 모든 컬렉션(공개+비공개)을 조회합니다. - 호주")
    @ApiResponses({
    ...
    @Operation(summary = "내 북마크 컬렉션 조회", description = "로그인한 사용자 본인이 북마크한 모든 컬렉션을 조회합니다. - 호주")
    @ApiResponses({
    ...
    @Operation(summary = "내 취향 키워드 재계산", description = "GPT를 호출하여 로그인한 사용자의 취향 키워드를 다시 계산합니다. - 호주")
    @ApiResponses({
    ...
    @Operation(summary = "사용자 프로필 조회", description = "특정 사용자의 프로필 정보를 조회합니다. - 호주")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "프로필 조회 성공")
    })
    ...
    @Operation(summary = "사용자 컬렉션 조회", description = "특정 사용자가 생성한 공개 컬렉션을 조회합니다. - 호주")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "컬렉션 조회 성공")
    })
    ...
    @Operation(summary = "사용자 북마크 컬렉션 조회", description = "특정 사용자가 북마크한 공개 컬렉션을 조회합니다. - 호주")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "북마크 컬렉션 조회 성공")
    })
