...
public enum UserErrorCode implements AppError {
        ...
        USER_SUSPENDED(HttpStatus.FORBIDDEN, "USER.SUSPENDED", "User Suspended", "정지된 사용자입니다."),
        USER_UPLOAD_RESTRICTED(HttpStatus.FORBIDDEN, "USER.UPLOAD_RESTRICTED", "User Upload Restricted", "업로드가 제한된 사용자입니다."),
