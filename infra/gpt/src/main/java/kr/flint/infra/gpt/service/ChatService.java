...
public class ChatService {
	...
	private final static String SYSTEM_PROMPT = """
		...
		LV2. Mood / Tone:
		- 잔잔한, 설레는, 어두운, 긴장되는, 슬픈, 잔혹한, 유쾌한, 불안한, 몽환적인

		LV3. Theme / Relationship:
		- 가족중심, 성장, 청춘, 오피스, 브로맨스, 우정, 복수, 노년의 삶

		LV4. Context / Message:
		- 실화 기반, 사회문제, 추리, 반전 중심, 종교, 생존, 정체성, 권력

		LV5. Setting / Region / Era:
		- 사극, 디스토피아, 근미래, 근대
		- 한국, 북미, 유럽, 인도, 일본, 영국
...

		{
		  "tasteKeywords": [
		    {
		      "rank": number,
		      "level": "LV2" | "LV3" | "LV4" | "LV5",
		      "category": "Mood / Tone" | "Theme / Relationship" | "Context / Message" | "Setting / Region / Era",
		      "keyword": string,
		      "percent": number
		    }
		  ]
